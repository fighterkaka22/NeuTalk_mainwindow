...
GuiCombWidget::GuiCombWidget(UsrProfileStruct *usrProfileStruct, QWidget *parent) : QWidget(parent)
{
  ...
  usr_name_palette.setColor(QPalette::WindowText, QColor(220,220,220));
  //好友IP颜色
  QPalette ip_addr_palette;
  ip_addr_palette.setColor(QPalette::WindowText, QColor(150,150,150));
  ...
  ip_addr_label->setPalette(ip_addr_palette);
